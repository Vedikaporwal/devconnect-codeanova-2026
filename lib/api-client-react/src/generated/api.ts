...
/**
 * Returns the status of the DevConnect API
 * @summary Health check
 */
export const health = async ( options?: Parameters<typeof customFetch>[1]): Promise<ApiHealthResponse> => {

  return customFetch<ApiHealthResponse>(getHealthUrl(),
  {
    ...options,
    method: 'GET'
